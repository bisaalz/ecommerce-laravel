            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            @if(isset($user) )
                                {{ Form::open(['url'=>route('user.update', $user->id), 'class'=>'form', 'enctype'=>'multipart/form-data']) }}
                                @method('PUT')
                            @else
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    {{ Form::select('role',['admin' => 'Admin','vendor' =>'Vendor','customer'=>'Customer'], @$user->role, ['class'=>'form-control', 'id'=>'status','required'=>true]) }}
